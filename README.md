...
| `blur_threshold` | 100 | 拉普拉斯方差阈值，**值越大判定为模糊的图越多** |
...
共发现 8421 张图片，开始分类...
  ...
  [500/8421] 手机:200 电脑:250 模糊:45 跳过:5 | 12.3 张/秒 | 预计剩余 644s
  [1000/8421] 手机:410 电脑:480 模糊:100 跳过:10 | 11.8 张/秒 | 预计剩余 629s
  ...
...
默认值 100 对大多数场景适用。**阈值越大，判定为模糊的图片越多**。如果你的图片整体偏柔和（如手绘、低光照片），可适当降低阈值（如 50）减少误判。运行后查看 `模糊/` 文件夹，根据结果微调。
</details>
